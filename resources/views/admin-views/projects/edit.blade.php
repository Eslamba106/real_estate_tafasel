...
@section('title')
    {{ translate('edit_property_management') }}
@endsection
@push('css_or_js')
...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- Form -->
        <form class="product-form text-start" action="{{ route('project.update', $project->id) }}" method="POST"
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label for="code" class="title-color">{{ translate('property_type') }}<span
                                ...
                                <select class="js-select2-custom form-control" name="property_type_id" required>
                                    ...
                                    @foreach ($property_types as $property_type)
                                        <option value="{{ $property_type->id }}" {{ ($project->type == $property_type->id) ? 'selected' : '' }}>{{ $property_type->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ translate('location') }}<span
                                        class="text-danger"> *</span></label>
                                <input type="text" class="form-control" value="{{ $project->location }}" name="location">
                                @error('location')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ translate('area') }} </label>
                                <input type="text" class="form-control" value="{{ $project->area }}" name="area">
                                @error('area')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ translate('description') }} </label>
