            ...
            <div class="px-3 py-4">
                <div class="row align-items-center  ">
                        ...
                        <form action="{{ url()->current() }}?search={{ $search }}" method="GET">
                            <div class="input-group input-group-merge input-group-custom">
                                ...
                                <input id="datatableSearch_" type="search" name="search" class="form-control"
                                    placeholder="{{ translate('search_role') }}" value="{{ $search }}">
                    ...
                    <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                        ...
                        <a href="{{ route('role_admin.create') }}" class="btn btn--primary">
                            <i class="tio-add"></i>
                            <span class="text">{{ translate('create_role') }}</span>
                        </a>
                    </div>
            ...
            <div class="pb-3">
                <div class="table-responsive">
                    <table class="table table-hover table-borderless table-thead-bordered table-align-middle card-table"
                        cellspacing="0" style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};">
