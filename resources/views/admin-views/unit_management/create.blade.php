                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="project"  onchange="get_floor_by_project(this.value)" required>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                response.floors.forEach(function (floor) {
                    $('#floor_select').append('<option value="' + floor.id + '">' + floor.floor_main.name + '</option>');
                });
            },
            error: function (xhr) {
