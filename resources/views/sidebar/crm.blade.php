                    ...
                    @if (\App\Helpers\Helpers::module_permission_check('show_all_customers'))
                     <div class="accordion-item ">
                         <h2 class="accordion-header list-group-item" id="headingTwo">
                             <a class="accordion-button"  href="{{ route('customer.index') }}"   >{{ translate('show_all_customers') }}</a>  
                     </div>
                     @endif 
                     @if (\App\Helpers\Helpers::module_permission_check('add_reminder'))
                     <div class="accordion-item ">
                         <h2 class="accordion-header list-group-item" id="headingTwo">
                             <a class="accordion-button"   href="{{ route('reminders.index') }}"  >{{ translate('my_reminders') }}</a>  
                         </h2>  
                     </div>
                     @endif 
                     ...
                     <div class="accordion-item ">
                         <h2 class="accordion-header list-group-item" id="headingTwo">
                             <a class="accordion-button"   href="{{ route('customer.installments_list') }}"  >{{ translate('installments') }}</a>  
                         </h2>  
                     </div>
                     @endif  
                 </div>
