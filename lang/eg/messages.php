<?php return array (
  ...
  'theme_settings' => 'اعدادات التصميم',
  ...
  'property_master.code' => 'Property master.code',
  'mobile' => 'Mobile',
  'office' => 'Office',
  'extension_no' => 'Extension no',
  'if_enabled_this_employee_item_will_be_available' => 'If enabled this employee item will be available',
  'if_disabled_this_employee_item_will_be_hidden' => 'If disabled this employee item will be hidden',
  'role' => 'Role',
  'property_master.updated_successfully' => 'Property master.updated successfully',
  'status_changed_successfully' => 'Status changed successfully',
  'add_new_employee' => 'Add new employee',
  'add_new_emplyee' => 'Add new emplyee',
  'roles' => 'Roles',
  'role_added_successfully' => 'Role added successfully',
  'edit unit description' => 'Edit unit description',
  'edit unit condition' => 'Edit unit condition',
  ...
  'create_role' => 'Create role',
  'unit_decription' => 'Unit decription',
  'add_unit_decription' => 'Add unit decription',
  'edit_unit_decription' => 'Edit unit decription',
  'delete_unit_decription' => 'Delete unit decription',
  'change_status_unit_decription' => 'Change status unit decription',
  'change_status_unit_condition' => 'Change status unit condition',
  'change_status_unit_type' => 'Change status unit type',
  'add_view' => 'Add view',
  'delete_view' => 'Delete view',
  'change_status_view' => 'Change status view',
  'add_property_type' => 'Add property type',
  'edit_property_type' => 'Edit property type',
  'delete_property_type' => 'Delete property type',
  'change_status_property_type' => 'Change status property type',
  'delete_floor' => 'Delete floor',
  'change_status_floor' => 'Change status floor',
  'add_projects' => 'Add projects',
  'edit_projects' => 'Edit projects',
  'delete_projects' => 'Delete projects',
  'change_status_projects' => 'Change status projects',
  'add_project' => 'Add project',
  'edit_project' => 'Edit project',
  'delete_project' => 'Delete project',
  'change_status_project' => 'Change status project',
  'add_floor_management' => 'Add floor management',
  'delete_floor_management' => 'Delete floor management',
  'change_status_floor_management' => 'Change status floor management',
  'add_unit_management' => 'Add unit management',
  'edit_unit_management' => 'Edit unit management',
  'delete_unit_management' => 'Delete unit management',
  'change_status_unit_management' => 'Change status unit management',
  'unit decription' => 'Unit decription',
  ...
  'facility_masters' => 'Facility masters',
  'add unit decription' => 'Add unit decription',
  'edit unit decription' => 'Edit unit decription',
  'delete unit decription' => 'Delete unit decription',
  'change status unit decription' => 'Change status unit decription',
  'add unit condition' => 'Add unit condition',
  'delete unit condition' => 'Delete unit condition',
  'change status unit condition' => 'Change status unit condition',
  'add unit type' => 'Add unit type',
  'delete unit type' => 'Delete unit type',
  'change status unit type' => 'Change status unit type',
  'add view' => 'Add view',
  'edit view' => 'Edit view',
  'delete view' => 'Delete view',
  'change status view' => 'Change status view',
  'add property type' => 'Add property type',
  'edit property type' => 'Edit property type',
  'delete property type' => 'Delete property type',
  'change status property type' => 'Change status property type',
  'add floor' => 'Add floor',
  'edit floor' => 'Edit floor',
  'delete floor' => 'Delete floor',
  'change status floor' => 'Change status floor',
  'add project' => 'Add project',
  'edit project' => 'Edit project',
  'delete project' => 'Delete project',
  'change status project' => 'Change status project',
  'add floor management' => 'Add floor management',
  'edit floor management' => 'Edit floor management',
  'delete floor management' => 'Delete floor management',
  'change status floor management' => 'Change status floor management',
  'unit management' => 'Unit management',
  'add unit management' => 'Add unit management',
  ...
  'transactions master' => 'Transactions master',
  ...
  'facility masters' => 'Facility masters',
  'facility transactions' => 'Facility transactions',
  'facility reports' => 'Facility reports',
  'general management' => 'General management',
  'show all unit management' => 'Show all unit management',
  'employee' => 'Employee',
  'show all employee' => 'Show all employee',
  'add employee' => 'Add employee',
  'edit employee' => 'Edit employee',
  'delete employee' => 'Delete employee',
  'change status employee' => 'Change status employee',
  'customer' => 'Customer',
  'show all customer' => 'Show all customer',
  'add customer' => 'Add customer',
  'edit customer' => 'Edit customer',
  'delete customer' => 'Delete customer',
  'assign to' => 'Assign to',
  'add reminder' => 'Add reminder',
  'change status customer' => 'Change status customer',
  'accept installment' => 'Accept installment',
  'installments customer' => 'Installments customer',
  'all installments' => 'All installments',
  'show_all_unit_description' => 'Show all unit description',
  'show_all_unit_condition' => 'Show all unit condition',
  'show_all_unit_type' => 'Show all unit type',
  'show_all_view' => 'Show all view',
  'show_all_property_type' => 'Show all property type',
  'show_all_floor' => 'Show all floor',
  'show_all_project' => 'Show all project',
  ...
  'show_all_team' => 'Show all team',
  'add_team' => 'Add team',
  'delete_team' => 'Delete team',
  'change_status_team' => 'Change status team',
  'show_all_employee' => 'Show all employee',
  'add_employee' => 'Add employee',
  'edit_employee' => 'Edit employee',
  'delete_employee' => 'Delete employee',
  'change_status_employee' => 'Change status employee',
  'show_all_roles' => 'Show all roles',
  'add_role' => 'Add role',
  'edit_role' => 'Edit role',
  'delete_role' => 'Delete role',
  'change_status_role' => 'Change status role',
  ...
  'change_status_customer' => 'Change status customer',
  'accept_installment' => 'Accept installment',
  'installments_customer' => 'Installments customer',
  'all_installments_for_admin' => 'All installments for admin',
  'update_role' => 'Update role',
  'role_updated_successfully' => 'Role updated successfully',
  'show all unit description' => 'Show all unit description',
  'show all unit condition' => 'Show all unit condition',
  'show all unit type' => 'Show all unit type',
  'show all view' => 'Show all view',
  'show all property type' => 'Show all property type',
  'show all floor' => 'Show all floor',
  'show all project' => 'Show all project',
  ...
  'Quarterly_installments_start_from_the_date' => 'Quarterly installments start from the date',
