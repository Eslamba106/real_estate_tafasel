...
class BusinessSettingsController extends Controller
{
    ...
    public function companyInfo()
    {
        ...
        $business_setting = [
            ...
            'decimal_point_settings' => !empty(\App\Helpers\Helpers::get_business_settings('decimal_point_settings')) ? \App\Helpers\Helpers::get_business_settings('decimal_point_settings') : 0,
        ];
    ...
    public function productSettings()
    {
        ...
        $digital_product =  BusinessSetting::where('type','digital_product')->first()->value;
        $brand = BusinessSetting::where('type','product_brand')->first()->value;
    ...
    public function update_seller_settings(Request $request)
    {
        ...
        // seller_pos
        $seller_pos = BusinessSetting::updateOrInsert(['type' => 'seller_pos'], [
